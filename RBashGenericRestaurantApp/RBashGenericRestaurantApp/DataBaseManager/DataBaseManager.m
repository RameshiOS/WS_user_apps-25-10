...
//  Properties
//
//  Created by Manulogix on 21/01/14.
...
-(id) init{
	...
	if (self){
        ...
        NSString *dataPath = [path stringByAppendingPathComponent:@"RbashUser"];
        ...
        _dataBasePath = [dataPath stringByAppendingPathComponent:@"Manu-DB-VAS-RbashUser.sqlite"];
		_database = nil;
		[self openDatabase];
...
- (NSString *) getDBPath{
	...
	NSString *documentsDir = [paths objectAtIndex:0];
     NSString *dataPath = [documentsDir stringByAppendingPathComponent:@"RHM"];
    ...
    returnStr =[dataPath stringByAppendingPathComponent:@"ManuLogix-Properties.sqlite"];
    return returnStr;
}
